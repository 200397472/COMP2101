...
echo "ERROR Occured. Please try again or use -x along with your bash shell to get error line to resolve."
}
...
function displayhelp {
    echo "use these option to get informations related to host."
    echo "-h|--help) displays help"
    echo "--host) displays hostname"
    echo "--domain) displays domain name"
    echo "--ipconfig) displays ip information"
    echo "--os) displays OS information"
    echo "--cpu) displays cpu information"
    echo "--memory) displays memory information"
    echo "--disk) displays disk information"
    echo "--printer) displays printer information"
}
...
function cleanup {
    rm -rf /tmp/*info*
    echo ">>>>>>> This echo chcks if ^c interrupt is trapped with trap 2 or not. <<<<<<<"
}
